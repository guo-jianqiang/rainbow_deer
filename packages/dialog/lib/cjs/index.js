...
function _objectWithoutPropertiesLoose(e, t) {
  if (null == e) return {}
  for (var n, o = {}, a = Object.keys(e), r = 0; r < a.length; r++)
...
function _objectWithoutProperties(e, t) {
  ...
  if (Object.getOwnPropertySymbols)
    for (var a = Object.getOwnPropertySymbols(e), r = 0; r < a.length; r++)
      (n = a[r]),
...
var classnames = createCommonjsModule(function (e) {
      ...
      if (n) {
        ...
        if ('string' == a || 'number' == a) e.push(n)
          ...
          if (n.toString === Object.prototype.toString)
            for (var r in n) l.call(n, r) && n[r] && e.push(r)
  ...
  var l
  ;(l = {}.hasOwnProperty), e.exports ? (e.exports = i.default = i) : (window.classNames = i)
})
function styleInject(e, t) {
  var n,
    o = (t = void 0 === t ? {} : t).insertAt
  e &&
    'undefined' != typeof document &&
    ((n = document.head || document.getElementsByTagName('head')[0]),
    ((t = document.createElement('style')).type = 'text/css'),
    'top' === o && n.firstChild ? n.insertBefore(t, n.firstChild) : n.appendChild(t),
...
var MemoChildren = React__default.default.memo(
    function (e) {
      return e.children
    },
    function (e, t) {
...
function isReactFragment(e) {
  return React__default.default.isValidElement(e) && e.type === React__default.default.Fragment
}
function insertSpace(e) {
  ...
  if (null != e) {
    ...
    return 'string' != typeof e &&
      ...
      ? React__default.default.cloneElement(e, { children: e.props.children.split('').join(t) })
      : 'string' == typeof e
      ? isTwoCNChar(e)
        ? React__default.default.createElement('span', null, e.split('').join(t))
        : React__default.default.createElement('span', null, e)
      : isReactFragment(e)
      ? React__default.default.createElement('span', null, e)
      : e
  }
...
var Button = function (e) {
    var t = e.type,
      ...
      l = classnames(''.concat(i, '-button'), a, n, l, { loading: d })
    return React__default.default.createElement(
      'button',
      _extends(
        {
      ...
      d &&
        React__default.default.createElement(
          'span',
          { className: ''.concat(i, '-button-loading') },
          React__default.default.createElement(Spin, { size: a, circleStyle: circleStyle[n] })
        ),
      insertSpace(o, r)
    )
  },
...
var _excluded$3 = ['icon', 'className'],
  Icon = function (e) {
    ...
    return e
      ? React__default.default.createElement(
          'i',
          _extends({ className: classnames('z-icon', n) }, o),
          React__default.default.createElement(e, { icon: t })
        )
      : null
  },
  ...
  Dialog = function (e) {
    ...
    var o = e.width,
      ...
      g = void 0 === p ? 200 : p,
      y = e.animationName,
      _ = void 0 === y ? defaultAnimationName : y,
      v = e.maskAnimationName,
      b = void 0 === v ? defaultAnimationName : v,
      h = e.zIndex,
      x = e.title,
      z = e.footer,
      w = e.footerStyle,
    ...
    var I,
      T,
      C = React__default.default.createElement(
        React__default.default.Fragment,
        null,
        React__default.default.createElement(Button, { style: { marginRight: 8 }, onClick: t }, S),
        React__default.default.createElement(
          Button,
          { loading: o, type: 'emphasize', onClick: n },
          C
        )
      )
    null !== z &&
      (L = React__default.default.createElement(
        'div',
        { className: classnames(''.concat(E, '-footer'), R), style: w },
        z && z.length
          ? z.map(function (e) {
              return React__default.default.isValidElement(e) ? e : null
            })
          : C
      )),
      x &&
        (I = React__default.default.createElement(
          'div',
          { className: ''.concat(E, '-header') },
          React__default.default.createElement('div', { className: ''.concat(E, '-title') }, x)
        )),
      u &&
        (T = React__default.default.createElement(
          'button',
          { type: 'button', onClick: t, 'aria-label': 'Close', className: ''.concat(E, '-close') },
          (React__default.default.isValidElement(d) && d) ||
            React__default.default.createElement(Icon, {
              icon: 'close',
              className: ''.concat(E, '-close-x'),
            })
        ))
    var r = React__default.default.createElement(
        'div',
        { className: classnames(''.concat(E, '-content'), i), style: l },
        T,
        I,
        React__default.default.createElement(
          'div',
          {
            ...
            style: _objectSpread2(_objectSpread2({}, c), {}, { height: r }),
          },
          y
        ),
        L
      ...
      L = React.useMemo(
        function () {
          return { width: a, animationName: m ? ''.concat(_, j ? 'In' : 'Out') : '' }
        },
        [m, a, _, j]
      )
    return React__default.default.createElement(
      'div',
      {
        ...
        style: _objectSpread2(
          {
            transition: m ? 'visibility var(--z-dialog-duration) linear' : '',
      ...
      React__default.default.createElement(
        'div',
        { className: 'z-dialog-wrap', style: { zIndex: h } },
        React__default.default.createElement(
          'div',
          {
            ref: s,
  ...
  DragWrapper = React__default.default.forwardRef(function (e, t) {
    var n = e.children,
      o = e.disabled,
      a = React.useRef(null),
      i = React.useRef({ max: { x: 0, y: 0 }, min: { x: 0, y: 0 } }),
      e = _slicedToArray(React.useState({ x: 0, y: 0 }), 2),
      l = e[0],
      c = e[1]
    React.useEffect(function () {
      function e() {
        ...
        i.current &&
          a.current &&
          ((e = (t = a.current).offsetWidth),
          (t = t.offsetHeight),
          (i.current.max.x = (window.innerWidth - e) / 2),
          (i.current.min.x = (e - window.innerWidth) / 2),
          (i.current.max.y = (window.innerHeight - t) / 2),
          (i.current.min.y = (t - window.innerHeight) / 2))
      }
      return (
        e(),
        ...
        (t.onMouseDown = function (e) {
          function t(e) {
            ...
            i.current &&
              ...
              (o = o - a + l.x),
              (e = e - r + l.y),
              o > t.x ? (o = t.x) : o < n.x && (o = n.x),
              e > t.y ? (e = t.y) : e < n.y && (e = n.y),
              c({ x: o, y: e }))
          }
          var n = e.clientX,
            e = e.clientY,
  ...
  DialogDrag = function (e) {
    var t = React.useRef(null),
      ...
      a = e.title,
      r = void 0 === a ? '' : a,
      a = _objectWithoutProperties(e, _excluded$2),
      e = _slicedToArray(React.useState(!0), 2),
      i = e[0],
      l = e[1]
    React.useEffect(
      function () {
        var e
        n && null !== (e = t.current) && void 0 !== e && e.restore()
      },
      [n]
    )
    return React__default.default.createElement(
      ...
      _extends(
        {
          ...
          title: React__default.default.createElement(
            'div',
            {
              ...
              style: { cursor: i ? '' : 'move', height: 16, lineHeight: '16px' },
            },
            r
          ),
          dialogRender: function (e) {
            return React__default.default.createElement(DragWrapper, { ref: t, disabled: i }, e)
          },
        },
        a
      ),
  ...
  DialogConfirm = function (e) {
    ...
    ;(m.id = 'z-confirm-' + getUUId()),
      ReactDom__default.default.render(
        React__default.default.createElement(
          l ? DialogDrag : DialogWrap,
          _extends({}, e, {
            visible: !0,
            onOk: function () {
          ...
          o || a
            ? React__default.default.createElement(
                ...
                React__default.default.isValidElement(a)
                  ? a
                  : o &&
                      React__default.default.createElement(Icon, {
                        icon: o,
                ...
                React__default.default.createElement(
                  'div',
                  { className: 'z-confirm-status-body-msg' },
                  i
                )
              )
            : i
        ...
        m,
        function () {
          ;(t = m.getElementsByClassName('z-dialog')[0]),
            (n = m.getElementsByClassName('z-dialog-mask')[0]),
            r || ((t.style.animationName = ''), (n.style.animationName = '')),
    ...
    var p = function () {
      function e() {
        ...
        null == m || (null !== (e = m.parentNode) && void 0 !== e && e.removeChild(m)),
          confirmQueue.splice(f.index, 1)
      }
      r
        ? ((t.style.animationName = s || defaultAnimationName + 'Out'),
          (n.style.animationName = u || defaultAnimationName + 'Out'),
          t.addEventListener('animationend', e))
        : e()
    }
    return confirmQueue.push(p), (f.index = confirmQueue.length - 1), p
  },
...
var _excluded = [
  ...
  DialogWrap = function (e) {
    var t = e.visible,
      ...
      s = _slicedToArray(React.useState(o), 2),
      e = s[0],
      u = s[1],
      f = React.useRef(t),
      s = _slicedToArray(React.useState(t), 2),
      m = s[0],
      p = s[1]
    React.useEffect(
      function () {
    ...
    return o || (!n && e) || m
      ? l()
        ? ReactDom__default.default.createPortal(
            React__default.default.createElement(Dialog, i, c),
            l()
          )
        : React__default.default.createElement(Dialog, i, c)
      : null
